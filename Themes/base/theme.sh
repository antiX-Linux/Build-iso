...
copy_file menu-applications-ice 	/usr/share/desktop-menu/.icewm/
...
#copy_file synaptic.desktop 		/usr/share/applications/antix/ ##full only
#copy_file system-config-printer.desktop /usr/share/applications/  ##full only
#copy_file umts-panel.desktop 		/usr/share/applications/  ##full only
...
#copy_dir streamtuner2/                  /etc/skel/.config/streamtuner2/     --create ##full only
